...
#define PLATFORM64_OSCONFIG_H
    ...
    *********************************/
    ...
    #define	STACKREALSTART_DRAM        (u64*)(STACKSTART_DRAM + STACKSIZE_DRAM/sizeof(u64))
    #define	STACKREALSTART_RDPFIFO     (u64*)(STACKSTART_RDPFIFO + STACKSIZE_RDPFIFO/sizeof(u64))
