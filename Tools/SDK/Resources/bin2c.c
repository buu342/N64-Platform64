 ...
 * Further modifications by Buu342
 * Also not gonna change the license.
 */
...
main(int argc, char *argv[])
{
    ...
    if (argc == 4) {
        ...
        char* outn = malloc(strl+1+sizeof(".h"));
        char* arrn = malloc(strl+1);
        strncpy(arrn, argv[1], strl);
